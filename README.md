...
Instead of analyzing *what* is written, ManaTyping reflects *how* writing happens — through typing rhythm, pauses, flow, and content-growth behavior.
...
- Thinking time
- Behavioral classification *(Natural / Reflective / Defaulter)*
